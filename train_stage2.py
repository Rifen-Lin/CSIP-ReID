...
from solver.make_optimizer import make_optimizer_1stage, make_optimizer_2stage
from solver.scheduler_factory import create_scheduler
from solver.lr_scheduler import WarmupMultiStepLR
from loss.make_loss import make_loss

from processor.processor_stage1_rrs import do_train_stage1
from processor.processor_stage2 import do_train_stage2_skeleton_fixed
...
if __name__ == "__main__":
    ...
    logger = setup_logger("CSIP-ReID", output_dir, if_train=True)
    ...
    model.load_param("./logs/mars/stage1/ckpts/epoch_120_stage1.pth")
    ...
    do_train_stage2_skeleton_fixed(
        cfg,
        model,
        center_criterion,
        train_loader_stage1_dense,
