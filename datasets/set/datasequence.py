...
class Datasequence(object):
    ...
    @property
    def skes_dir(self):
        return osp.join(self.root, "skes")
    ...
    def load(self, seq_len, seq_str, num_val=0.3, verbose=True):
        ...
        self.identities_ske = self.meta["identities_skes"]
    ...
    def _check_integrity(self):
        return (
            osp.isdir(osp.join(self.root, "images"))
            and osp.isfile(osp.join(self.root, "meta.json"))
            and osp.isfile(osp.join(self.root, "splits.json"))
        )
